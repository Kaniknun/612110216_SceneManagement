...
public class MainMenuControlScript : MonoBehaviour
{
  ...
  public void TorqueClick(Button button){
    SceneManager.LoadScene("TorqueScene");
  }
      
        public void RestitutionClick(Button button){
    SceneManager.LoadScene("RestitutionScene");
  }
}
